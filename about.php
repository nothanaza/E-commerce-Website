            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div class="stats-bg">
                            <i class="fas fa-users text-secondary-foreground" style="font-size: 2rem;"></i>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="stats-bg">
                            <i class="fas fa-box-open text-secondary-foreground" style="font-size: 2rem;"></i>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="stats-bg">
                            <i class="fas fa-calendar-alt text-secondary-foreground" style="font-size: 2rem;"></i>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="stats-bg">
                            <i class="fas fa-users-cog text-secondary-foreground" style="font-size: 2rem;"></i>
                        </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="card rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300">
                        <div class="value-bg">
                            <i class="fas fa-tachometer-alt value-foreground" style="font-size: 2rem;"></i>
                        </div>
                    ...
                    <div class="card rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300">
                        <div class="value-bg">
                            <i class="fas fa-check-circle value-foreground" style="font-size: 2rem;"></i>
                        </div>
                    ...
                    <div class="card rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300">
                        <div class="value-bg">
                            <i class="fas fa-users value-foreground" style="font-size: 2rem;"></i>
                        </div>
                    ...
                    <div class="card rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300">
                        <div class="value-bg">
                            <i class="fas fa-headset value-foreground" style="font-size: 2rem;"></i>
                        </div>
