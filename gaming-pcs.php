        ...
        if ($product_exists && $product_exists['in_stock']) {
            if (isset($_SESSION['user_id'])) {
                ...
                try {
                    ...
                    $referer = $_SERVER['HTTP_REFERER'] ?? '/E-commerce-Website/gaming-pcs.php';
                    $anchor = strpos($referer, '#') !== false ? parse_url($referer, PHP_URL_FRAGMENT) : 'product-' . $product_id;
                    header("Location: /E-commerce-Website/gaming-pcs.php#" . $anchor);
                    exit;
        ...
        <div class="products-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <a href="E-commerce-Website/product.php?id=1">
                ...
                <div class="product-info">
                    ...
                    <form method="POST" action="/E-commerce-Website/gaming-pcs.php">
