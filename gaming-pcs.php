...
if (isset($_POST['add_to_cart'])) {
    ...
    header("Location: /E-commerce-Website-main/E-commerce-Website/gaming-pcs.php");
    exit;
}
...
<title>Gaming Hardware Store - Gaming PCs</title>
...
<body>
        ...
        <div class="container">
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <h3 class="feature-title">Latest Processors</h3>
                    <p class="feature-sub">Intel Core i7 &amp; i9, AMD Ryzen</p>
                </div>
                <div class="feature-card">
                    <div class="icon-wrap">
                        <div class="icon-inner"><i class="fas fa-bolt"></i></div>
                    </div>
                    <h3 class="feature-title">RTX Graphics</h3>
                    <p class="feature-sub">NVIDIA RTX 4060 to RTX 4080</p>
                </div>
                <div class="feature-card">
                    <div class="icon-wrap">
                        <div class="icon-inner"><i class="fas fa-hdd"></i></div>
                    </div>
                    <h3 class="feature-title">SSD Storage</h3>
                    <p class="feature-sub">Fast NVMe drives up to 1TB</p>
                </div>
                <div class="feature-card">
                    <div class="icon-wrap">
                        <div class="icon-inner"><i class="fas fa-desktop"></i></div>
                    </div>
                    <h3 class="feature-title">Gaming Ready</h3>
                    <p class="feature-sub">Optimized for 1080p to 4K gaming</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="products-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <a href="/E-commerce-Website-main/E-commerce-Website/product.php?id=1">
                        <img src="https://images.unsplash.com/photo-1636914011676-039d36b73765?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBQQyUyMGRlc2t0b3AlMjBjb21wdXRlcnxlbnwxfHx8fDE3NTcwMTc2MTN8MA&ixlib=rb-4.1.0&q=80&w=1080" alt="TechGiant Gaming PC Elite">
                    </a>
                    <span class="discount-badge">-10%</span>
                </div>
                <div class="product-info">
                    <h3 class="product-title">TechGiant Gaming PC Elite</h3>
                    <p class="category">gaming-pcs</p>
                    <div class="rating">
                        <span class="stars">
                        ...
                        <span class="reviews">(247)</span>
                    </div>
                    <div class="price">
                        <span class="current">R44,999.99</span>
                        <span class="old">R49,999.99</span>
                    </div>
                    <form method="POST" action="/E-commerce-Website-main/E-commerce-Website/gaming-pcs.php">
                        <input type="hidden" name="id" value="1">
                        <input type="hidden" name="name" value="TechGiant Gaming PC Elite">
                        <input type="hidden" name="price" value="R44,999.99">
                        <input type="hidden" name="image" value="https://images.unsplash.com/photo-1636914011676-039d36b73765?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBQQyUyMGRlc2t0b3AlMjBjb21wdXRlcnxlbnwxfHx8fDE3NTcwMTc2MTN8MA&ixlib=rb-4.1.0&q=80&w=1080">
            ...
            <div class="product-card">
                <div class="product-image">
                    <a href="/E-commerce-Website-main/E-commerce-Website/product.php?id=1">
                        <img src="https://images.unsplash.com/photo-1636914011676-039d36b73765?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBQQyUyMGRlc2t0b3AlMjBjb21wdXRlcnxlbnwxfHx8fDE3NTcwMTc2MTN8MA&ixlib=rb-4.1.0&q=80&w=1080" alt="TechGiant Gaming PC Ultra">
                    </a>
                    <span class="discount-badge">-15%</span>
                </div>
                <div class="product-info">
                    <h3 class="product-title">TechGiant Gaming PC Ultra</h3>
                    <p class="category">gaming-pcs</p>
                    <div class="rating">
                        <span class="stars">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i>
                        ...
                        <span class="reviews">(312)</span>
                    </div>
                    <div class="price">
                        <span class="current">R59,999.99</span>
                        <span class="old">R69,999.99</span>
                    </div>
                    <form method="POST" action="/E-commerce-Website-main/E-commerce-Website/gaming-pcs.php">
                        <input type="hidden" name="id" value="1">
            ...
            <div class="product-card">
                <div class="product-image">
                    <a href="/E-commerce-Website-main/E-commerce-Website/product.php?id=1">
                        <img src="https://images.unsplash.com/photo-1636914011676-039d36b73765?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBQQyUyMGRlc2t0b3AlMjBjb21wdXRlcnxlbnwxfHx8fDE3NTcwMTc2MTN8MA&ixlib=rb-4.1.0&q=80&w=1080" alt="TechGiant Gaming PC Titan">
                    </a>
                    <span class="discount-badge">-8%</span>
                </div>
                <div class="product-info">
                    <h3 class="product-title">TechGiant Gaming PC Titan</h3>
                    <p class="category">gaming-pcs</p>
                    <div class="rating">
                        <span class="stars">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i>
                    ...
                    <div class="price">
                        <span class="current">R74,999.99</span>
                        <span class="old">R81,999.99</span>
                    </div>
                    <form method="POST" action="/E-commerce-Website-main/E-commerce-Website/gaming-pcs.php">
                        <input type="hidden" name="id" value="1">
    ...
    <div class="custom">
        <div class="icon">&#128421;</div>
        <h1>Need a Custom Build?</h1>
        <p>Our experts can help you build the perfect gaming PC tailored to your needs and budget</p>
    </div>
