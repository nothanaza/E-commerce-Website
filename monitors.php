...
if (isset($_POST['add_to_cart'])) {
    ...
    header("Location: /E-commerce-Website-main/E-commerce-Website/monitors.php");
    exit;
}
...
<title>Gaming Hardware Store - Monitors</title>
...
<body>
        ...
        <div class="container">
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <h3 class="feature-title">High Refresh Rate</h3>
                    <p class="feature-sub">144Hz - 240Hz+ displays</p>
                </div>
                <div class="feature-card">
                    <div class="icon-wrap">
                    ...
                    <p class="feature-sub">1ms response time</p>
                </div>
                <div class="feature-card">
                    <div class="icon-wrap">
                        <div class="icon-inner"><i class="fas fa-eye"></i></div>
                    </div>
                    <h3 class="feature-title">HDR Support</h3>
                    <p class="feature-sub">Enhanced visuals</p>
                </div>
                <div class="feature-card">
                    <div class="icon-wrap">
                        <div class="icon-inner"><i class="fas fa-medal"></i></div>
                    </div>
                    <h3 class="feature-title">G-Sync/FreeSync</h3>
                    <p class="feature-sub">Tear-free gaming</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="product-section">
        <h2>Premium Gaming Monitor Selection</h2>
        <p class="tagline">From competitive 240Hz panels to stunning 4K displays - find your perfect gaming monitor</p>
        <div class="products-grid">
            <!-- Product 1 -->
            <div class="product-card">
                <div class="product-image">
                    <a href="/E-commerce-Website-main/E-commerce-Website/product.php?id=4">
                        <img src="https://images.unsplash.com/photo-1696710240292-05aad88b94b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtb25pdG9yJTIwc2V0dXB8ZW58MXx8fHwxNzU3MDE3NjE0fDA&ixlib=rb-4.1.0&q=80&w=1080" alt="4K Gaming Monitor 27&quot;">
                    </a>
                    <span class="discount-badge">-15%</span>
                </div>
                <div class="product-info">
                    <h3 class="product-title">4K Gaming Monitor 27&quot;</h3>
                    <p class="category">monitors</p>
                    <div class="rating">
                        <span class="stars">
                    ...
                    <div class="price">
                        <span class="current">R10,999.99</span>
                        <span class="old">R12,999.99</span>
                    </div>
                    <form method="POST" action="/E-commerce-Website-main/E-commerce-Website/monitors.php">
                        <input type="hidden" name="id" value="4">
                        <input type="hidden" name="name" value="4K Gaming Monitor 27&quot;">
                        <input type="hidden" name="price" value="R10,999.99">
                        <input type="hidden" name="image" value="https://images.unsplash.com/photo-1696710240292-05aad88b94b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtb25pdG9yJTIwc2V0dXB8ZW58MXx8fHwxNzU3MDE3NjE0fDA&ixlib=rb-4.1.0&q=80&w=1080">
            ...
            <div class="product-card">
                <div class="product-image">
                    <a href="/E-commerce-Website-main/E-commerce-Website/product.php?id=4">
                        <img src="https://images.unsplash.com/photo-1696710240292-05aad88b94b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtb25pdG9yJTIwc2V0dXB8ZW58MXx8fHwxNzU3MDE3NjE0fDA&ixlib=rb-4.1.0&q=80&w=1080" alt="34&quot; Ultrawide Gaming Monitor">
                    </a>
                    <span class="discount-badge">-13%</span>
                </div>
                <div class="product-info">
                    <h3 class="product-title">34&quot; Ultrawide Gaming Monitor</h3>
                    <p class="category">monitors</p>
                    <div class="rating">
                        <span class="stars">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i>
                    ...
                    <div class="price">
                        <span class="current">R12,499.99</span>
                        <span class="old">R14,999.99</span>
                    </div>
                    <form method="POST" action="/E-commerce-Website-main/E-commerce-Website/monitors.php">
                        <input type="hidden" name="id" value="4">
                        <input type="hidden" name="name" value="34&quot; Ultrawide Gaming Monitor">
                        <input type="hidden" name="price" value="R12,499.99">
                        <input type="hidden" name="image" value="https://images.unsplash.com/photo-1696710240292-05aad88b94b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtb25pdG9yJTIwc2V0dXB8ZW58MXx8fHwxNzU3MDE3NjE0fDA&ixlib=rb-4.1.0&q=80&w=1080">
                        <input type="hidden" name="quantity" value="1">
                        <button type="submit" name="add_to_cart" class="add-to-cart">
                            <i class="fas fa-shopping-cart"></i> Add to Cart
            ...
            <div class="product-card">
                <div class="product-image">
                    <a href="/E-commerce-Website-main/E-commerce-Website/product.php?id=4">
                        <img src="https://images.unsplash.com/photo-1696710240292-05aad88b94b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBtb25pdG9yJTIwc2V0dXB8ZW58MXx8fHwxNzU3MDE3NjE0fDA&ixlib=rb-4.1.0&q=80&w=1080" alt="27&quot; QHD 240Hz Gaming Monitor">
                    </a>
                </div>
                <div class="product-info">
